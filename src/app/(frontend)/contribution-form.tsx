  ...
  return (
    <>
      <div className="ring-2 ring-black rounded-lg  mx-auto my-2 bg-slate-200">
        ...
        <div>
          <h1 className=" text-2xl font-bold text-center py-2"> Contribution Form </h1>
        </div>
        <Form {...form}>
          <form
                ...
                <FormItem>
                  ...
                  <Select onValueChange={field.onChange} defaultValue={field.value}>
                    ...
                    <SelectContent>
                      ...
                      <SelectItem value="4star">4 star: 180 USDT</SelectItem>
                      <SelectItem value="5star">5 star: 380 USDT</SelectItem>
                      <SelectItem value="6star">6 star: 580 USDT</SelectItem>
                    </SelectContent>
                  </Select>
